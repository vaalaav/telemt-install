...
При установке доступен **4-й пункт — «свой инстанс»**: пользователь сам задаёт SNI-домен и порт. Это можно использовать как вместо одного из стандартных пресетов, так и **вместе** с ними.

При выборе кастомного инстанса:
- Сначала спрашивается **SNI домен**.
- Затем спрашивается **порт** (1–65535).
