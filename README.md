...
- **VLESS Reality upstream** — туннелирует трафик telemt → Telegram DC через ваш VLESS-сервер.
  На выбор: одна `vless://` ссылка ИЛИ подписка 3x-ui (`https://...`) с балансировкой по нескольким узлам.
