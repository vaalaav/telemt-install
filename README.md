...
Скрипт интерактивно спрашивает: SSH-порт, какие инстансы поднимать, и хочешь ли ставить дополнительные компоненты (UFW, keepalive, nft, таймауты)
---
...
После установки доступна команда `sudo mytelemtinfo` — TUI-меню с подменю под каждый компонент. 
